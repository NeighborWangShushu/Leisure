...
#define SHOPINFOLIST_URL       @"http://api2.pianke.me/group/posts_info" // 良品详情
...
// 登录注册
#define LOGIN_URL              @"http://api2.pianke.me/user/login" // 登录接口
#define REGISTER_URL           @"http://api2.pianke.me/user/reg" // 注册接口
